...
23.2.4.1 Нужно запомнить, что применении этой функции к массиву вложенному в массив, то эта функция только обрежет только
пробелы у массива первого уровня, а у второго нет.
